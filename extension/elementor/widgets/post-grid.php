...
class nhakhoa_widget_post_grid extends Widget_Base {
    ...
    public function get_name() {
        return 'nhakhoa-post-grid';
    }

    public function get_title() {
        return esc_html__( 'Posts Grid', 'nhakhoa' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'options'   =>  [
                    ...
                    'author'        =>  esc_html__( 'Post Author', 'nhakhoa' ),
        ...
        $this->add_control(
            'column_number',
            [
                'label'     =>  esc_html__( 'Column', 'nhakhoa' ),
                'type'      =>  Controls_Manager::SELECT,
                'default'   =>  3,
                'options'   =>  [
                    4   =>  esc_html__( '4 Column', 'nhakhoa' ),
                    3   =>  esc_html__( '3 Column', 'nhakhoa' ),
                    2   =>  esc_html__( '2 Column', 'nhakhoa' ),
                    1   =>  esc_html__( '1 Column', 'nhakhoa' ),
                ],
            ]
        );
...
Plugin::instance()->widgets_manager->register_widget_type( new nhakhoa_widget_post_grid );